...
do_install_append () {
    ...
    sed -i -e 's,@@SRVGRP,${SRV_GRP},g' ${D}${sysconfdir}/thttpd.conf
    sed -i -e 's,@@SRVCGI,${SRV_CGI},g' ${D}${sysconfdir}/thttpd.conf
